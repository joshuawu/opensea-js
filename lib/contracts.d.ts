...
export declare const getMethod: (abi: Readonly<import("./types").PartialAbiDefinition>[], name: string) => MethodAbi;
export declare const event: (abi: Readonly<import("./types").PartialAbiDefinition>[], name: string) => EventAbi;
